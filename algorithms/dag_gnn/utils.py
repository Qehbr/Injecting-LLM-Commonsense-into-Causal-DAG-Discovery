...
#========================================
def my_softmax(input_tensor, axis=1): # Changed 'input' to 'input_tensor' to avoid overriding built-in
    trans_input = input_tensor.transpose(axis, 0).contiguous()
    # The dimension 'axis' in the original input_tensor is now at dimension 0 in trans_input
